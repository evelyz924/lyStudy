// 0618slide_banner_01_result.js

(function($) {
  // slide_btn 내부 버튼요소를 변수로 처리
  ...
  // 순서를 만드는 변수를 생성 (indicaator, slideBtn 기능에도 영향이 있다)
  var i = 0;
...
// --------------------------------------------------------
  ...
  // 해당 요소(선택된 요소)에 클래스 이름을 부여 ('active')
  // 선택된 요소의 순서값( index() ) 파악
  // 광고배너의 클래스 이름을 제거
  // 선택요소와 동일한 위치의 광고배너 클래스 이름을 부여('active')
...
// ------------------------------------------------------------------------
  ...
  // 광고배너의 이전이미지와 다음이미지의 내용이 보이게 만들기
